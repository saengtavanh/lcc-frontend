...
import {CustomLanguageSwitcher} from '../../../../app/components/CustomLanguageSwitcher'
...
export function HeaderWrapper() {
  ...
  return (
    ...
    >
      {/* begin::Container */}
      <div className='ms-10 d-flex align-items-center justify-content-between' id='kt_header_container'>
        <DefaultTitle />
        {/* begin::Wrapper */}
        <div className={'d-flex d-lg-none align-items-center ms-n2 me-2'}>
          ...
          <Link to='/dashboard' className='d-flex align-items-center'>
            <img alt='Logo' src="https://kumonos.co.jp/wps/wp-content/themes/kumonos/img/common/cropped-kumonos-site_icon-32x32.png" className='h-30px' />
          </Link>
          {/* end::Logo */}
        </div>
        {/* end::Wrapper */}
