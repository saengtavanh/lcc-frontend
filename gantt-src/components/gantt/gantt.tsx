...
export const Gantt: React.FunctionComponent<GanttProps> = ({
  ...
  weekendColor = "rgba(255, 0, 0, 0.3)",
  holidayColor = "rgba(255,0, 0, 0.3)",
  holidays,
  viewDate,
  ...
  //   return taskEndDate > max ? taskEndDate : max;
  // }, new Date(tasks[0].end)); // Initialize with the end date of the first task
